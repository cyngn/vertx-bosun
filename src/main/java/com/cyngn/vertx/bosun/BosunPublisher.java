...
public class BosunPublisher {
     ...
     */
    public <T,U> void indexMetric(String metric, T value, JsonObject tags,
     ...
     * @param <U> the type of object coming back in the response
     */
    public <T,U> void putMetric(String metric, T value, JsonObject tags,
                              Handler<AsyncResult<Message<U>>> onComplete) {
     ...
     */
    private <U> void sendMessage(JsonObject msg, Handler<AsyncResult<Message<U>>> onComplete) {
        if (onComplete != null) {
